...
import belenkov.repast.ru.repasttestapp.controller.adapters.FavoritesItemsAdapter
        ...
        RestaurantApi.getFavoriteRestaurants()
            ...
            .subscribe { favoriteRestaurants ->
                run {
                    ...
                    val reviewRecycler = view.favoritesRecycler
                    val adapter = FavoritesItemsAdapter(list, context!!)
